...
class PreviousCabinet(models.Model):
    ...
    year_of_service = models.CharField(max_length=20, help_text='academic year of operation')
...
class Contestants(models.Model):
    ...
    sex = models.CharField(max_length=10, choices=sexes, help_text='Sex', default='')
    post = models.CharField(max_length=100, help_text='post of leadership')
    nomination = models.IntegerField(help_text='Student Nomination', default=0)

    def __str__(self):
        return self.full_name

class CurrentCabinet(models.Model):
    colleges = [('CEDAT', 'College Of Engineering Design Art ANd Technology'),
                ('COBAMS', 'Economics')
                ]
    departments = []
